...
def list_all_species_names_from_file_path(file_path="data/current_dataset.tsv"):
...
def return_all_mitochondrion_genome_sequences_as_dict(species_names, folder_path="species_files"):
